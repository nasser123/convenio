...
public final class Impressao
{
    ...
    /**
     * @param impressora impressora a ser utilizada
     * @param arquivo arquivo a ser impresso
     * @param vias número de vias para imprimir
     * @throws java.awt.print.PrinterException
     * @throws java.io.IOException
     */
    public static void imprimir(PrintService impressora, String arquivo, Integer vias) throws PrinterException, IOException
    {
        ...
        try (PDDocument document = Loader.loadPDF(file))
        {
            ...
            print(document, impressora, vias);
            //ListaImpressoras.
     ...
     */
    private static void print(PDDocument document, PrintService impressora, Integer vias) throws PrinterException
    {
